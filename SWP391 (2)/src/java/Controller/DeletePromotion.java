...
public class DeletePromotion extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean checkDelete = objectDao.deletePromotion(promotionID);
        if (!checkDelete){
            request.setAttribute("messDeletePromotion", "Khuyến mãi này được sử dụng trong đơn hàng! Đảm bảo khuyến mãi không được bất kỳ đơn hàng nào sử dụng trước khi xóa.");
        }
