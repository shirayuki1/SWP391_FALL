...
public class CreateMaterial extends HttpServlet {
    ...
    private final MaterialDAO objectDao = new MaterialDAO();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            boolean result = objectDao.addMaterial(materialName);
            if(result){
                request.setAttribute("messAddMaterial", "Tạo nguyên liệu thành công");
            }else{
                            request.setAttribute("messAddMaterial", "Tạo nguyên liệu thành công!");
            }
